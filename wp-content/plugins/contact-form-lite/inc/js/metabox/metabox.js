          ...
          intro.setOptions({
            steps: [
              ...
              },
              {
                ...
                intro: "You can click on here to edit the field, for example edit the placeholder, icon etc. You also can drag & drop to re-order the fields.",
                position: 'right'
              },
              {
              ...
              {
                element: '#ecfdemodiv',
                intro: "You can see the <b>DEMO</b> first before you buy.",
                position: 'left'
              },		  
