    ...
    global $current_user, $post;
		if ( !empty( $post ) && 'easycontactform' === $post->post_type && is_admin() ) {
        	...
        	/* Check that the user hasn't already clicked to ignore the message */
        		...
        		printf(__('Earn <span style="color: red;">EXTRA MONEY</span> and get 30&#37; affiliate share from every sale you make!&nbsp;&nbsp;<a href="https://ghozylab.com/plugins/affiliate-program/" target="_blank">JOIN GHOZYLAB AFFILIATE PROGRAM NOW!</a><span style="float: right;"><a href="%1$s">Hide Notice</a><span>'), '?ecf_nag_ignore=0');
        		echo "</p></div>";
    			}
			}
}
